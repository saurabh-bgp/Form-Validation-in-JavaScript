...
function validateName(){
    ...
    nameError.innerHTML = "";
    nameError.previousElementSibling.classList.add('bx-check');
    return true;
}
...
function validateEmail(){
    ...
    emailError.previousElementSibling.classList.add('bx-check');
    return true;
}
function validatePassword(){
    ...
    passError.innerHTML = "";
    passError.previousElementSibling.classList.add('bx-check');
    return true;
}
